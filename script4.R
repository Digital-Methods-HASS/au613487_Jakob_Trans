...
rawdata3 <- read.csv(url("https://raw.githubusercontent.com/Digital-Methods-HASS/au613487_Jakob_Trans/main/Digital%20Methods%20exam/data/rawdata.csv"))

view(rawdata3)

#Opening the data and making R count missing data as missing.
  #I will name the vector 'cleandata', as I am going to clean it up and I do not want to mess with the raw data or create confusion.

cleandata <- rawdata3
view(cleandata2)

cleandata3 <- (cleandata2| na = "NULL")
